...
class ParceirosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parceiro" do
    assert_difference('Parceiro.count') do
      post parceiros_url, params: { parceiro: { cep: @parceiro.cep, cidade: @parceiro.cidade, endereco: @parceiro.endereco, estado: @parceiro.estado, nome: @parceiro.nome } }
    end
  ...
  test "should update parceiro" do
    patch parceiro_url(@parceiro), params: { parceiro: { cep: @parceiro.cep, cidade: @parceiro.cidade, endereco: @parceiro.endereco, estado: @parceiro.estado, nome: @parceiro.nome } }
