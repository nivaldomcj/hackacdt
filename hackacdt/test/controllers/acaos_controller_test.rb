...
class AcaosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create acao" do
    assert_difference('Acao.count') do
      post acaos_url, params: { acao: { descricao: @acao.descricao, dt_fim: @acao.dt_fim, dt_inicio: @acao.dt_inicio, nome: @acao.nome, organizacao_id: @acao.organizacao_id } }
    end
  ...
  test "should update acao" do
    patch acao_url(@acao), params: { acao: { descricao: @acao.descricao, dt_fim: @acao.dt_fim, dt_inicio: @acao.dt_inicio, nome: @acao.nome, organizacao_id: @acao.organizacao_id } }
